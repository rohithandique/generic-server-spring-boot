...
class HttpFilterTest {
  ...
  @InjectMocks private HttpFilter httpFilter;
  ...
  @Test
  void doFilterInternal_ShouldRedirect_WhenUriEndsWithSlashAndIsNotRoot()
  ...
  @Test
  void doFilterInternal_ShouldChain_WhenUriDoesNotEndWithSlash()
      throws ServletException, IOException {
    // Arrange
